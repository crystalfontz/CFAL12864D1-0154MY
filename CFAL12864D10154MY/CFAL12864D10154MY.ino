...
#include "CFAL12864D10154MY_Splash.h"
...
void OLED_Init()
{
  ...
  writeCommand(0x05); // Set Contrast Control for Bank 0
                      //   Default => 0x7F
...
void setup()
{
  ...
  SET_WR;
  SET_CS;
  //setup mySerial to use as a debug port if necessary. 
  //If talking to the display via SPI, mySerial can be changed to the standard "Serial"
  mySerial.begin(9600);
  delay(100);
  for (int i = 0; i < 20; i++)
  {
...
#define fillscreendemo    0
#define checkerboarddemo  0
#define linesdemo         0
#define splashdemo        1
